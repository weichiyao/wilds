...
class Camelyon17DatasetNoisy(WILDSDatasetNoisy):
    """
    ...
    def __init__(self, version=None, root_dir='data', download=False, split_scheme='official',
        ...
        # Get the y values 
        self._y_array_orc = torch.LongTensor(self._metadata_df['tumor'].values) 
        self._y_size = 1
        self._n_classes = 2
        self._y_array = torch.LongTensor(_flip_data(self._metadata_df['tumor'].values, noise_ratio, self._n_classes, seed))
